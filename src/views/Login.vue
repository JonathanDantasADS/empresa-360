        ...
        <nav class="navbar navbar-light bg-light menu-superior">
            <div class="container">
                ...
                <div class="navbar-nav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <router-link :to="{ path: '/' }" class="nav-link">Volta</router-link>
                        </li>
                    </ul>
                </div>
            </div>
...
//              this.$router.back() // volta no histórico de rotas do navegador
//              this.$router.go(2) // avançar ou voltar no histórico de rotas do navegador
//              this.$router.go(-2) // avançar ou voltar no histórico de rotas do navegador
            }
        }
    }
